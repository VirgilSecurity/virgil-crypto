...
macro( CSHARP_ADD_PROJECT type name )
  ...
  set( CSHARP_COMPILER_OPTIONS )
  # Check build type
  if ( CMAKE_BUILD_TYPE STREQUAL "Debug" OR CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo" )
    set( CSHARP_COMPILER_OPTIONS "/debug" ${CSHARP_COMPILER_OPTIONS})
  endif ()

  # Add custom target and command
  MESSAGE( STATUS "Adding C# ${type} ${name}: '${CSHARP_COMPILER} /t:${type} /out:${name}.${output} /platform:${CSHARP_PLATFORM} ${CSHARP_SDK} ${CSHARP_COMPILER_OPTIONS} ${refs} ${sources}'" )
  add_custom_command(
    COMMENT "Compiling C# ${type} ${name}: '${CSHARP_COMPILER} /t:${type} /out:${name}.${output} /platform:${CSHARP_PLATFORM} ${CSHARP_SDK} ${CSHARP_COMPILER_OPTIONS} ${refs} ${sources}'"
    OUTPUT ${CSHARP_BINARY_DIRECTORY}/${name}.${output}
    COMMAND ${CSHARP_COMPILER}
    ARGS /t:${type} /out:${name}.${output} /platform:${CSHARP_PLATFORM} ${CSHARP_SDK} ${CSHARP_COMPILER_OPTIONS} ${refs} ${sources}
